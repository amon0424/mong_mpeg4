...
add wave -noupdate -expand -group DMA -radix hexadecimal -expand -subitemconfig {/testbench/cpu/dma0/r.srcaddr {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.srcinc {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstaddr {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstinc {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.len {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.enable {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.inhibit {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.status {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstate {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data {-height 15 -radix hexadecimal -expand} /testbench/cpu/dma0/r.data(0) {-radix hexadecimal} /testbench/cpu/dma0/r.data(1) {-radix hexadecimal} /testbench/cpu/dma0/r.data(2) {-radix hexadecimal} /testbench/cpu/dma0/r.data(3) {-radix hexadecimal} /testbench/cpu/dma0/r.data(4) {-radix hexadecimal} /testbench/cpu/dma0/r.data(5) {-radix hexadecimal} /testbench/cpu/dma0/r.data(6) {-radix hexadecimal} /testbench/cpu/dma0/r.data(7) {-radix hexadecimal} /testbench/cpu/dma0/r.data(8) {-radix hexadecimal} /testbench/cpu/dma0/r.data(9) {-radix hexadecimal} /testbench/cpu/dma0/r.data(10) {-radix hexadecimal} /testbench/cpu/dma0/r.data(11) {-radix hexadecimal} /testbench/cpu/dma0/r.data(12) {-radix hexadecimal} /testbench/cpu/dma0/r.data(13) {-radix hexadecimal} /testbench/cpu/dma0/r.data(14) {-radix hexadecimal} /testbench/cpu/dma0/r.data(15) {-radix hexadecimal} /testbench/cpu/dma0/r.data(16) {-radix hexadecimal} /testbench/cpu/dma0/r.data(17) {-radix hexadecimal} /testbench/cpu/dma0/r.data(18) {-radix hexadecimal} /testbench/cpu/dma0/r.data(19) {-radix hexadecimal} /testbench/cpu/dma0/r.data(20) {-radix hexadecimal} /testbench/cpu/dma0/r.data(21) {-radix hexadecimal} /testbench/cpu/dma0/r.data(22) {-radix hexadecimal} /testbench/cpu/dma0/r.data(23) {-radix hexadecimal} /testbench/cpu/dma0/r.data(24) {-radix hexadecimal} /testbench/cpu/dma0/r.data(25) {-radix hexadecimal} /testbench/cpu/dma0/r.data(26) {-radix hexadecimal} /testbench/cpu/dma0/r.cnt {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.readCountInRow {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_stride {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dst_stride {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_width {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dst_width {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_mcomp {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.rfactor {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.mcomp_mode {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.beat {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write_valid {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write_addr {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/r
...
add wave -noupdate -expand -group DMA -radix hexadecimal -subitemconfig {/testbench/cpu/dma0/dmao.Grant {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.OKAY {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Ready {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Retry {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Fault {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Data {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/dmao
...
add wave -noupdate -expand -group {view3-mcomp to dma} -radix hexadecimal /testbench/cpu/my_mcomp/ram/WE1
add wave -noupdate -expand -group {view3-mcomp to dma} -radix hexadecimal /testbench/cpu/my_mcomp/ram/Data_In1
...
add wave -noupdate -expand -group {view3-mcomp to dma} -radix hexadecimal -subitemconfig {/testbench/cpu/dma0/r.data(0) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(1) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(2) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(3) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(4) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(5) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(6) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(7) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(8) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(9) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(10) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(11) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(12) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(13) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(14) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(15) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(16) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(17) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(18) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(19) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(20) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(21) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(22) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(23) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(24) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(25) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(26) {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/r.data
add wave -noupdate -expand -group {view3-mcomp to dma} /testbench/cpu/my_mcomp/mode
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {226770366 ps} 1} {{Cursor 2} {234171751 ps} 1} {{Cursor 3} {231021000 ps} 0}
...
update
WaveRestoreZoom {230855034 ps} {231289027 ps}
