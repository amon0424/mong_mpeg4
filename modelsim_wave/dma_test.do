...
add wave -noupdate -group DMA -radix hexadecimal -expand -subitemconfig {/testbench/cpu/dma0/r.srcaddr {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.srcinc {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstaddr {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstinc {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.idstaddr {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.idstinc {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.len {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.enable {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.inhibit {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.status {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dstate {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.stage {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.cnt {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.readCountInRow {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_stride {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dst_stride {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_width {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.dst_width {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.src_mcomp {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.rfactor {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.mcomp_mode {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.beat {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write_valid {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.write_addr {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/r
...
add wave -noupdate -expand -group {view2-dma to mcomp} -radix hexadecimal /testbench/cpu/dma0/r.dstate
...
add wave -noupdate -expand -group {view2-dma to mcomp} -color Magenta -radix hexadecimal /testbench/cpu/dma0/mst/AHBOut.haddr
add wave -noupdate -expand -group {view2-dma to mcomp} -color Magenta -radix hexadecimal /testbench/cpu/dma0/mst/AHBOut.hwdata
add wave -noupdate -expand -group {view2-dma to mcomp} -color Yellow -radix unsigned /testbench/cpu/dma0/mst/AHBIn.hready
add wave -noupdate -expand -group {view2-dma to mcomp} -radix hexadecimal /testbench/cpu/dma0/mst/DMAOut.Ready
add wave -noupdate -expand -group {view2-dma to mcomp} -radix hexadecimal /testbench/cpu/my_mcomp/wr_valid
...
add wave -noupdate -expand -group {view2-dma to mcomp} -color Magenta -radix hexadecimal /testbench/cpu/my_mcomp/ram/DataMEM
...
add wave -noupdate -expand -group {view3-mcomp to dma (hv)} -radix hexadecimal /testbench/cpu/my_mcomp/hv_tmp
add wave -noupdate -expand -group {view3-mcomp to dma (hv)} -radix hexadecimal -expand -subitemconfig {/testbench/cpu/dma0/r.data(0) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(1) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(2) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(3) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(4) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(5) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(6) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(7) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(8) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(9) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(10) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(11) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(12) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(13) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(14) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(15) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(16) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(17) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(18) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(19) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(20) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(21) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(22) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(23) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(24) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(25) {-height 15 -radix hexadecimal} /testbench/cpu/dma0/r.data(26) {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/r.data
...
add wave -noupdate -group {view4-dma to ram} -radix hexadecimal /testbench/cpu/dma0/mst/AHBOut.hwrite
...
add wave -noupdate -group {view4-dma to ram} -color Yellow -radix hexadecimal /testbench/cpu/dma0/mst/AHBIn.hready
add wave -noupdate -group {view4-dma to ram} -color Yellow -radix unsigned /testbench/cpu/dma0/mst/DMAIn.Request
...
WaveRestoreCursors {{Cursor 5} {241876055 ps} 1} {{Cursor 5} {163220463 ps} 0}
...
update
WaveRestoreZoom {163135700 ps} {163809700 ps}
