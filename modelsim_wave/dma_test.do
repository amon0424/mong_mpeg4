...
add wave -noupdate -expand -group DMA -radix hexadecimal -expand -subitemconfig {/testbench/cpu/dma0/dmao.Grant {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.OKAY {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Ready {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Retry {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Fault {-height 15 -radix hexadecimal} /testbench/cpu/dma0/dmao.Data {-height 15 -radix hexadecimal}} /testbench/cpu/dma0/dmao
...
add wave -noupdate -expand -group {MCOMP RAM} -radix unsigned /testbench/cpu/my_mcomp/ram/Addr2
...
add wave -noupdate -expand -group {view4-dma to ram} -radix unsigned /testbench/cpu/dma0/mst/AHBOut.hburst
add wave -noupdate -expand -group {view4-dma to ram} -radix unsigned /testbench/cpu/dma0/mst/AHBOut.htrans
add wave -noupdate -expand -group {view4-dma to ram} -radix hexadecimal /testbench/cpu/dma0/mst/DMAIn.Address
add wave -noupdate -expand -group {view4-dma to ram} -color Yellow -radix hexadecimal /testbench/cpu/dma0/mst/AHBOut.haddr
add wave -noupdate -expand -group {view4-dma to ram} -radix hexadecimal /testbench/cpu/dma0/r.beat
add wave -noupdate -expand -group {view4-dma to ram} -color Cyan -radix hexadecimal /testbench/cpu/dma0/mst/AHBOut.hwdata
add wave -noupdate -expand -group {view4-dma to ram} -color Cyan -radix hexadecimal /testbench/cpu/dma0/mst/AHBIn.hready
...
add wave -noupdate -expand -group {view4-dma to ram} -color Coral -radix hexadecimal /testbench/cpu/dma0/mst/DataPhase
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {226770366 ps} 1} {{Cursor 2} {234171751 ps} 1} {{Cursor 4} {227746249 ps} 1} {{Cursor 5} {231820283 ps} 1} {{Cursor 5} {248185973 ps} 0}
...
update
WaveRestoreZoom {247912362 ps} {248382362 ps}
